    ...
    return (
        ...
        <div className="!mx-auto w-[1000px] h-[250px] bg-white rounded-lg flex flex-row justify-between items-center py-2 border-[1px] !mb-4 transition hover:border-gray-600">
            <div className="flex px-8">
                ...
                <img src={props.image} alt={props.title} className='w-[250px] h-auto max-h-[150px]' />
                ...
                <div className='w-max flex flex-col justify-start items-start mt-4 !ml-8'>
                    ...
                    <div className="flex flex-row">
                        <svg class="w-[18px] h-[18px] text-yellow-500 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <svg class="w-[18px] h-[18px] text-yellow-500 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-width="2" d="M11.083 5.104c.35-.8 1.485-.8 1.834 0l1.752 4.022a1 1 0 0 0 .84.597l4.463.342c.9.069 1.255 1.2.556 1.771l-3.33 2.723a1 1 0 0 0-.337 1.016l1.03 4.119c.214.858-.71 1.552-1.474 1.106l-3.913-2.281a1 1 0 0 0-1.008 0L7.583 20.8c-.764.446-1.688-.248-1.474-1.106l1.03-4.119A1 1 0 0 0 6.8 14.56l-3.33-2.723c-.698-.571-.342-1.702.557-1.771l4.462-.342a1 1 0 0 0 .84-.597l1.753-4.022Z" />
                        </svg>
                        <p className="!ml-2 text-[14px] !mb-2">(14)</p>
                    </div>
                    <p className="text-[13px]">
                        Częstotliwość odświeżania: <b>100 Hz</b> <br />
                        Nowa klasa energetyczna: <b>Klasa E</b> <br />
                        Przekątna ekranu: <br />
                        Rozdzielczość: <b>1920 x 1080</b> (FullHD) <br />
                        Typ matrycy: <b>IPS</b> <br />
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-col justify-between items-start px-8">
                <div>
                    <p><span className='text-[24px]'>{props.price}, 00 zł</span></p>
                    <u className="text-[15px]">rata od 51,40zł</u>
                </div>
