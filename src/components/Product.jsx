...
import aorus from '../media/Aorus.png'
import aorus2 from '../media/aorus2.png'
import aorus3 from '../media/aorus3.png'
import aorus4 from '../media/aorus4.png'
import aorus5 from '../media/aorus5.png'
...
export default function Header() {
    ...
    return (
        <div className='w-full max-w-[1300px] !mx-auto !pt-[50px] flex justify-between items-start flex-row'>
            <div>
                <div>
                    <img src={aorus} alt="" className='w-[500px]' />
                    <div className='flex flex-row'>
                        <img src={aorus} alt="" className='w-[95px] border-2 border-violet-700 !mr-1' />
                        <img src={aorus2} alt="" className='w-[95px] border-2 !ml-1 hover:border-violet-500 cursor-pointer' />
                        <img src={aorus3} alt="" className='w-[95px] border-2 !ml-1 hover:border-violet-500 cursor-pointer' />
                        <img src={aorus4} alt="" className='w-[95px] border-2 !ml-1 hover:border-violet-500 cursor-pointer' />
                        <img src={aorus5} alt="" className='w-[95px] border-2 !ml-1 hover:border-violet-500 cursor-pointer' />
                    </div>
                </div>
            ...
            <div className='w-[800px] min-h-[600px] flex flex-col justify-start !ml-8'>
                <div className='text-left'>
                    <p className='text-[28px]'>
                        Gigabyte AORUS 7 9KF i5-12500H
                    </p>
                    <div>
          ...
          >
            <p className='w-full'>Brak</p>
                    ...
                    <div className='w-[320px] h-max border-2 text-right py-4 px-2 rounded-lg'>
                        <p className='text-[28px] pr-2'>4 848,00 zł</p>
                        <div className='!mt-4 text-center'>
                            <input type="number" className='border-2 w-[50px] h-[50px] text-center !mr-4 rounded-lg' value={1} />

                            <a href='koszyk' className='!mt-4 px-8 py-3 bg-violet-800 hover:bg-violet-900 text-white rounded-md z-[1000]'>Dodaj do koszyka<svg class="w-[17px] h-[17px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <div className='w-full flex !mt-4 px-2 border-t-2 !pt-2'>
                            ...
                            <span className='text-[14px]'>Rata już od <u>123,44 zł</u></span>
                        </div>
                    </div>
                </div>
            </div>
