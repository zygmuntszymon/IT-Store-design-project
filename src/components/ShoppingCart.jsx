...
import plyta_glowna from '../media/plytaglowna.png'
import procesor from '../media/procesor.png'
...
export default function ShoppingCart() {
    return (
        <div className="w-full flex flex-row justify-center items-center !pt-[20px]">
            <div className="!mx-auto w-full max-w-[1300px] flex justify-between items-center flex-col">
                ...
                <div className='flex flex-row !mt-8'>
                    <div className="w-[70%] border-2 rounded-lg">
                        <div className='flex flex-row justify-between items-center px-4 py-4'>
                            <img src={plyta_glowna} className='w-[150px]'></img>
                            <div className='w-[600px] text-left !pl-8'>
                                <p>Płyta główna MSI B550-A PRO</p>
                            </div>
                            <div className='flex flex-row items-center justify-center'>
                                <span className='!mr-4 text-lg w-max'>469,00zł</span>
                                <input type="number" className='border-2 w-[40px] text-center !mr-4 rounded-lg'  value={1}/>
                                <svg class="w-6 h-6 text-gray-800 hover:text-gray-400 cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M8.586 2.586A2 2 0 0 1 10 2h4a2 2 0 0 1 2 2v2h3a1 1 0 1 1 0 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V8a1 1 0 0 1 0-2h3V4a2 2 0 0 1 .586-1.414ZM10 6h4V4h-4v2Zm1 4a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Zm4 0a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Z" clip-rule="evenodd" />
                                </svg>
                            </div>
                        </div>
                        <hr />
                        <div className='flex flex-row justify-between items-center px-4 py-4'>
                            <img src={procesor} className='w-[150px]'></img>
                            <div className='w-[600px] text-left !pl-8'>
                                <p>AMD Ryzen 5 5600</p>
                            </div>
                            <div className='flex flex-row items-center justify-center'>
                                <span className='!mr-4 text-lg w-max'>449,00zł</span>
                                <input type="number" className='border-2 w-[40px] text-center !mr-4 rounded-lg'  value={1}/>
                                <svg class="w-6 h-6 text-gray-800 hover:text-gray-400 cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M8.586 2.586A2 2 0 0 1 10 2h4a2 2 0 0 1 2 2v2h3a1 1 0 1 1 0 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V8a1 1 0 0 1 0-2h3V4a2 2 0 0 1 .586-1.414ZM10 6h4V4h-4v2Zm1 4a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Zm4 0a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Z" clip-rule="evenodd" />
                                </svg>
                        ...
                        <hr />
                        <div className='flex flex-row justify-between items-center px-4 py-4'>
                            <img src={ram} className='w-[150px]'></img>
                            <div className='w-[600px] text-left !pl-8'>
                                <p>Lexar 32GB (2x16GB) 6000MHz</p>
                            </div>
                            <div className='flex flex-row items-center justify-center'>
                                <span className='!mr-4 text-lg w-max'>549,00zł</span>
                                <input type="number" className='border-2 w-[40px] text-center !mr-4 rounded-lg' value={1}/>
                                <svg class="w-6 h-6 text-gray-800 hover:text-gray-400 cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M8.586 2.586A2 2 0 0 1 10 2h4a2 2 0 0 1 2 2v2h3a1 1 0 1 1 0 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V8a1 1 0 0 1 0-2h3V4a2 2 0 0 1 .586-1.414ZM10 6h4V4h-4v2Zm1 4a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Zm4 0a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Z" clip-rule="evenodd" />
                                </svg>
                        ...
                        <hr />
                        <div className='flex flex-row justify-between items-center px-4 py-4'>
                            <img src={windows} className='w-[150px]'></img>
                            <div className='w-[600px] text-left !pl-8'>
                                <p>Microsoft Windows 11 Pro OEM DVD PL</p>
                            </div>
                            <div className='flex flex-row items-center justify-center'>
                                <span className='!mr-4 text-lg w-max'>769,00zł</span>
                                <input type="number" className='border-2 w-[40px] text-center !mr-4 rounded-lg' value={1}/>
                                <svg class="w-6 h-6 text-gray-800 hover:text-gray-400 cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M8.586 2.586A2 2 0 0 1 10 2h4a2 2 0 0 1 2 2v2h3a1 1 0 1 1 0 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V8a1 1 0 0 1 0-2h3V4a2 2 0 0 1 .586-1.414ZM10 6h4V4h-4v2Zm1 4a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Zm4 0a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Z" clip-rule="evenodd" />
                                </svg>
                        ...
                        <hr />
                        <p className="w-full text-[20px] font-bold !mt-8 px-4">Dodatkowe usługi</p>

                        <div className="w-full">
                            <div className='flex flex-row justify-between items-center px-4 py-4'>
                            <div className='w-[600px] text-left'>
                                <p>Wniesienie oraz montaż podzespołów</p>
                            </div>
                            <div className='flex flex-row items-center justify-center'>
                                <span className='!mr-4 text-lg w-max'>199,00zł</span>
                                <input type="number" className='border-2 w-[40px] text-center !mr-4 rounded-lg'  value={1}/>
                                <svg class="w-6 h-6 text-gray-800 hover:text-gray-400 cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M8.586 2.586A2 2 0 0 1 10 2h4a2 2 0 0 1 2 2v2h3a1 1 0 1 1 0 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V8a1 1 0 0 1 0-2h3V4a2 2 0 0 1 .586-1.414ZM10 6h4V4h-4v2Zm1 4a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Zm4 0a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0v-8Z" clip-rule="evenodd" />
                                </svg>
                            ...
                            <div className='flex flex-row justify-between items-center px-4 py-4'>
                            <div className='w-[600px] text-left'>
                                <p>Instalacja systemu operacyjnego</p>
                            </div>
                            <div className='flex flex-row items-center justify-center'>
                                <span className='!mr-4 text-lg w-max'>199,00zł</span>
                                <input type="number" className='border-2 w-[40px] text-center !mr-4 rounded-lg'  value={1}/>
